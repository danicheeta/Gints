...
func TestValidateJWT(t *testing.T) {
	generator := NewJWTGenerator("1cfabccbf188251666dfa066a88864a7")
	jwt := generator.GenerateJWT("hamed", "master")
...
func TestDecode(t *testing.T) {
	generator := NewJWTGenerator("1cfabccbf188251666dfa066a88864a7")
	payload := generator.Decode(generator.GenerateJWT("hamed1soleimani@gmail.com", "master"))
	expectedEmail := "hamed1soleimani@gmail.com"
	expectedAdmin := "master"
...
func TestRenewJWT(t *testing.T) {
	generator := NewJWTGenerator("1cfabccbf188251666dfa066a88864a7")
	jwt := generator.GenerateJWT("hamed1soleimani@gmail.com", "master")
